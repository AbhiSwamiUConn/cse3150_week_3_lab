...
def test_add_single_reading_then_print():
    ...
    assert "A: 1.2" in out
test_add_single_reading_then_print()
def test_add_two_readings_then_print():
    ...
    assert "A: 1.2" in out
    assert "B: 3.8" in out
test_add_two_readings_then_print
# ---------- Update via pointer ----------
...
test_update_bad_index_reports_error()
...
test_insert_when_full_reports_error()
...
test_average_on_empty_reports_error()
def test_min_on_empty_reports_error():
    ...
    code, out = run(BIN, args=(3,), stdin_data=input_seq)
    assert "Error: Empty" in out
test_min_on_empty_reports_error()
def test_max_on_empty_reports_error():
    ...
    code, out = run(BIN, args=(3,), stdin_data=input_seq)
    assert "Error: Empty" in out
test_max_on_empty_reports_error()
# ---------- Unknown selections ----------
...
test_unknown_menu_choice_prints_message()
...
test_unknown_compute_option_prints_message()
